...
/**
  ...
  * @返回值：接收到的长度
  */
uint8_t SX127X_RxPacket_cjy(uint8_t*cbuf)
{
...
tSX127xError SX127X_FreqSet(void)
{
    ...
    if((G_LoRaConfig.LoRa_Freq > 930000000) || (G_LoRaConfig.LoRa_Freq < 401000000))
        return PARAMETER_INVALID;
