...
#define	CONNECT_ERR_GPSON	    0x22
#define CONNECT_ERR_GPSOFF         0x23
#define CONNECT_ERR_CPSINFO        0x24
#define CONNECT_ERR_NONE		0x00

#define SIM7600_SendStr(str)            UART4_Tx(str,strlen((char*)str))
#define	SIM7600_SendData(pdata,size)	UART4_Tx(pdata,size)
